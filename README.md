...
This repository designs a forkable OSS business for specialized design activities -- fashion, industrial, graphic and interior design services for clients -- run by a qualified, licensed operator so a community or
...
the physical domain work**. Here a fabrication/prototyping robot produces physical design mockups/prototypes,
under an actor that proposes actions and an independent **Design Delivery Governor**
...
approval and audit evidence: releasing a final deliverable to a client.
...
The governed actor implementation (`Designer-LLM` + `Design Delivery Governor` as
