...
- the Design Delivery Governor remains independent of the advisor.
...
- releasing a final deliverable to a client always escalates to a human -- never automated.
...
- bypassing the Design Delivery Governor's policy checks
