# Operator Quickstart — Specialized design activities

Shortest path from clone to a verified local dry-run for **ISIC 7410** (`cloud-itonami-isic-7410`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7410.git
cd cloud-itonami-isic-7410
```
...
- Blueprint governor key: `design-delivery-governor`
- Likely source path: `design.governor.cljc`
